...
process.on('config',
        function(config, callback){
            ...
            var getType = {};
            if(getType.toString.call(procedure) == '[object String]'){
                procedure = JASON.parse(procedure);
                console.log("Parsed to: " + getType.toString.call(procedure));
            }
            subid = config.subid;
            host = config.host;
            port = config.port;
...
function isFunction(functionToCheck) {
    ...
    console.log("getType.toString.call(functionToCheck) == '[object Function]'?\t" + getType.toString.call(functionToCheck));
